...
BEGIN
  ...
  -- NEW POINTS: participation bonus + 4 per win (Swiss and Top Cut equal)
  UPDATE tournament_results tr SET
    base_points = PARTICIPATION_BONUS,
  ...
  -- Players with no match data get participation bonus only
  ...
  -- UPDATE PROFILE TOTALS (exclude external tournaments)
  UPDATE profiles p
